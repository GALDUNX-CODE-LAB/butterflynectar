...
const PerckCheck = () => {
    return ( <div className="contained gap-2">
      ...
      <p className="w-full text-shared text-[13px]">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 mt-5 transition-all ease-in-out duration-500">
             {array.map((x)=>(
            <Tilt scale={1} transitionSpeed={800} key={x.id} >
             <div className="p-4 flex flex-col gap-3 justify-center items-center bg-background rounded-2xl hover:animate-bounce transition-all">
                <div className="p-4 bg-[#D9D9D980] rounded-full text-2xl">
                    {x.icon}
                </div>
