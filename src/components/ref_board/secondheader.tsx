  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="contained  order-4 lg:order-1  md:col-span-7">
        <h3 className="w-full text-left font-bold font-Ruska text-[16px]">How to offer</h3>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3 justify-between items-center mt-3">
          <div className=" flex flex-col gap-3 text-center justify-center items-center">
            <Image src={nextSvg} alt="name" width={70} height={70} className="rounded-full" placeholder="blur" />
      ...
      <div className="contained gap-2 order-1 lg:order-2  md:col-span-3">
        <h3 className="w-full text-left font-bold font-Ruska text-[16px]">REFERRAL STATS</h3>
        ...
        <div className="flex flex-col justify-center relative items-center">
          ...
          <h1 className="text-3xl font-bold font-Ruska absolute top-[40%]">53 %</h1>
          <p className="w-full text-shared text-[13px] absolute bottom-0 text-center">
            You’ve referred more than 53% of users and destributors!
          </p>
        </div>
      </div>
      <div className=" order-2 lg:order-3  md:col-span-3">
        <div className="contained gap-2">
          <h3 className="w-full text-left text-shared font-bold font-Ruska text-[16px]">QUICK ACTION</h3>
