    ...
    <div className="grid grid-cols-1 gap-5">
      <div className="flex flex-col items-start rounded-3xl p-5 bg-white gap-7">
        ...
        <div className="grid grid-cols-2 gap-3 w-full">
          <div className="flex flex-col items-start">
            <span className="text-xs mb-1">Username</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="p-5 rounded-3xl bg-white">
          ...
          <p className="text-sm text-black opacity-40 mb-5">A short description here</p>
        ...
        <div className="p-5 rounded-3xl bg-white">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <h1 className="text-[16px] font-Ruska font-semibold flex items-center">
                <TbMilitaryRankFilled className="text-[#5849EF] text-lg" />
                CONNECTOR PRO
              </h1>
            </div>
            <div>
              <span className="text-[13px] text-black opacity-40 mb-5">Referral Link</span>
              <h1 className="text-[13px] font-Ruska font-semibold flex items-center">
                {" "}
                Ox...e34581aud &nbsp; <MdOutlineContentCopy className="text-[#5849EF]" />
              </h1>
            </div>
          </div>
        </div>
      ...
      <div className="p-5 bg-white rounded-3xl">
        <h1 className="text-lg font-Ruska font-bold mb-1 text-[#606060]">Referrals</h1>
        <ProfileTag />
      </div>
    </div>
  );
