...
import { LetterText, PhoneCall } from "lucide-react";
...
const Firstprofile = () => {
    ...
    <div className="grid grid-cols-1 gap-5">
        ...
        <ul className="text-left w-full text-[#000000A6] text-xs">
            <li className="flex items-center mb-2"><FaEnvelope/>&nbsp;&nbsp;Davidexample@gmail.com</li>
            <li className="flex items-center mb-2"><LuPhone />&nbsp;&nbsp;+2348186490349</li>
            <li className="flex items-center mb-2"><FaRegAddressCard />&nbsp;&nbsp;#11378908</li>
            <li className="flex items-center mb-2"><FaPeopleArrows/>&nbsp;&nbsp;#11378908</li>
        </ul>
    </div> 
    <div className="p-5 relative bg-white rounded-3xl hover:animate-bounce transition-all duration-500">
