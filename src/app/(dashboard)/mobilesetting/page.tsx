...
const MobileSetting = () => {
    return ( <div>
       ...
       <div>
        ...
        <button className="text-[13px] bg-[#5849EF] rounded-2xl py-3 px-4 font-[400] text-white">
            Edit Profile
        </button>
        </div>
        ...
        <div className="rounded-3xl bg-white p-4 mb-3">
              <h1 className="font-Ruska font-bold text-xl mb-2">
            Setting
        </h1>
        ...
        <div className="bg-white p-5 rounded-3xl mb-3">
            ...
            <Switch
              defaultChecked
              className="data-[state=checked]:bg-[#5849EF]"
            />
          </div>
        </div>
