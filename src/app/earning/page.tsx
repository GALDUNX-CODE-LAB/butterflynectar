...
const EarningPage = () => {
    ...
    <div className="transition-all duration-500 bg-white p-5 rounded-3xl mt-5">
          <h3 className="w-full text-left font-bold font-Ruska text-xl mb-2">
      Redemption Tab
      </h3>
      <p className="w-full text-shared text-[13px]">
       Check team progress and success
      </p>
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 mt-5">
        <Tilt className="p-5 flex flex-col items-center justify-center bg-background rounded-3xl">
            ...
            <div className="w-full mt-5">
                <h4 className="mb-3 text-[#00000066] opacity-40 text-xs">
                    History
                </h4>
        ...
        <Tilt className="p-5 flex flex-col items-center justify-center bg-background rounded-3xl">
            <div className="bg-[#CFEE49] flex flex-col items-center justify-center gap-5 w-full p-3 md:p-5 rounded-3xl">
                <div className="w-full flex items-center justify-between">
                    ...
                    <button className="bg-black text-white text-[13px] py-2 px-4 rounded-3xl font-semibold">Withdraw</button>
                </div>
                 <div className="w-full flex items-center justify-between">
                 <div>
